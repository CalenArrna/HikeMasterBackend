...
public class QMessages extends EntityPathBase<Messages> {
    ...
    private static final long serialVersionUID = 1642698645L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QMessages messages = new QMessages("messages");

    public final QHikeMasterUser hikeMasterUser;
    ...
    public QMessages(Class<? extends Messages> type, PathMetadata metadata, PathInits inits) {
        ...
        this.hikeMasterUser = inits.isInitialized("hikeMasterUser") ? new QHikeMasterUser(forProperty("hikeMasterUser")) : null;
