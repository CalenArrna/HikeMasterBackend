...
public class HikeRouteController {
    ...
    public ResponseDTO postHikeRoute(@RequestBody String tour_type, String route_type, String difficultly, Integer tour_length, Integer level_rise,Integer rate) {
